...
<div class="row">
    ...
    <div class="col s4 offset-s4" style="border:1px solid black;">
      <ul class="tabs">
        <li class="tab col s6" style="display:block;"><a  style="color:black;" href="#resources">Resources</a></li>
        <li class="tab col s6"><a class="active" href="#link" style="color:black;">Links</a></li>
       </ul>
    </div>
    </center>
...
{!! Form::close() !!}
<div class="col s2 m2  offset-m3 offset-s4">
  <a class="waves-effect btn" href="/upload">Upload</a>
<
</div>
</div>
